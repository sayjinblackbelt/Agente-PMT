...
A proposta não é simplesmente gerar um currículo.

O estudante é conduzido por um processo de:
...
Como o público é composto por adolescentes, o projeto também adota cuidados específicos com **privacidade e proteção de dados**.
